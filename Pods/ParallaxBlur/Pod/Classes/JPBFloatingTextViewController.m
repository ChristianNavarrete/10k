...
- (void)viewDidLoad{
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, [self headerHeight] - 50, self.view.frame.size.width - 15 - [self horizontalOffset], 25)];
    ...
    _subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, [self headerHeight] - 25, self.view.frame.size.width - 15 - [self horizontalOffset], 15)];
